...
export function parseLohacoProductUrl(url: string): LohacoIds | null {
...
export function parseAmazonProductUrl(url: string): AmazonIds | null {
  const parsed = parseHttpUrl(url);
...
export function isProductMetaFetchableUrl(url: string): boolean {
